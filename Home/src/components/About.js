...
export default function Tentang() {
    return (
        ...
        //     <Container className="text-center text-white about col-lg-8">
        //             <h3 className="text-white fw-bold pt-3 mb-4">About</h3>
        //             <div className='isi pb-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus 
        //                 repudiandae blanditiis qui earum illo sit porro nemo error ducimus 
        //                 repellendus atque asperiores, nulla excepturi quam esse voluptatibus 
        //                 ab impedit, veniam fugiat fugit numquam provident officia praesentium harum. 
        //                 Esse omnis officiis ab, possimus accusamus voluptatem natus minima aliquam tenetur
        //                 beatae quo corrupti minus temporibus ducimus nostrum neque velit illo ipsa impedit!
        //                 Vel, beatae distinctio. Modi, tempore consequuntur laborum vero, molestiae id a 
        //                 quaerat consequatur fugiat molestias perferendis possimus dolores repudiandae quam 
        //                 non accusamus repellat quibusdam maiores.</div>
        //     </Container>
                ...
                <div className='row'>
                    ...
                    <div className='col-lg-3 col-md-6'>
                        <Card className='mb-5 text-center d-flex align-items-center pt-2 bg-dark border border-warning'>
                            ...
                            <Benefit manfaat={'Accurate Data'} deskripsi={'Kami menyediakan informasi yang akurat tentang film. Data yang ditampilkan, seperti pemain, sutradara, tahun rilis, dan ringkasan plot.'}></Benefit>
                        </Card>
                    </div>
