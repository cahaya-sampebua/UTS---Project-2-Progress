...
import './info.css'
import gambar1 from '../gambar/ip.jpg'
...
export default function Infofilm(props) {
    return(
        ...
        <Container fluid>
            <Button variant="outline-success border border-success mt-3"><BsBackspaceFill></BsBackspaceFill> Back</Button>
            <Container className="py-5 content">
                <div className="row">
                    

                    <div className="col-lg-6 gambar col-md-6 mb-sm-5 mb-5 mb-md-0">
                        <img className="picture border border-warning border-2" src={gambar1}></img>
                    </div>
